...
export default function LandingScreen() {
  ...
  }, [fadeIn, slideUp, pulseAnim, iconFloat1, iconFloat2, iconFloat3]);
      ...
      >
        <View style={styles.iconRow}>
          ...
          <Animated.View style={[styles.featureIcon, styles.featureIconMemory, { transform: [{ translateY: iconFloat2 }] }]}>
            <Brain size={28} color={Colors.teal} />
          </Animated.View>
        ...
        <Text style={styles.subtitle}>
          Test your reaction, memory & logic{'\n'}in under 45 seconds
        </Text>
        ...
        <View style={styles.statsRow}>
          ...
          <View style={[styles.statBadge, styles.statBadgeCenter]}>
            <Text style={styles.statNumber}>45s</Text>
